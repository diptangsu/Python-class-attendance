...
if (count($_GET) > 0) 
{
    ...
    $sub = 
    '<div class="output">
    <a href="../process/submit-assignment.php">
    Submit Assignments
    </a>
    </div>';
    echo $sub;
    ...
    $sub = 
    '<div class="output">
    <a download role="button" href="../admin/assignment-questions/assignment1.txt" target="_blank">Download Assignment 1
    </a>
    <br>
    <a download role="button" href="../admin/assignment-questions/assignment2.txt" target="_blank">Download Assignment 2
    </a>
    </div>';
    echo $sub;
}
